...
model = tf.keras.models.load_model('braintumor.h5')
image_size = 150  # Define your image size
labels = ['glioma_tumor', 'meningioma_tumor', 'no_tumor', 'pituitary_tumor']
...
# --- Initialize Flask App ---
app = Flask(__name__)
run_with_ngrok(app)  # Automatically creates ngrok tunnel and prints public URL
...
def predict():
    ...
    try:
        ...
        return jsonify({
            ...
            'confidence': float(np.max(prediction))  # Optional: confidence score
        })
...
from google.colab import files
files.download('braintumor.h5')

!pip install tensorflowjs
!tensorflowjs_converter --input_format=keras braintumor.h5 tfjs_model/
